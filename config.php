<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/nazish/opencart_store/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/nazish/opencart_store/');

// DIR
define('DIR_APPLICATION', '/var/www/html/nazish/opencart_store/catalog/');
